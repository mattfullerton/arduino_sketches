 ...
 * 
 * You might see slight remnants of the example code here: https://support.sodaq.com/Boards/Autonomo/Examples/tph/
 * even though this sketch doesn't use that sensor.
 * 
 * Example code for Dallas Temperature was used and can be found here:
 * https://wiki.seeedstudio.com/One-Wire-Temperature-Sensor-DS18B20/
 * 
 * which is very similar to the example from the library:
 ...
 *
 * You need to install the OneWire and Dallas Temperature libraries.
 * 
 * As far as any code here that I have contributed is concerned, an MIT license applies if possible
 * (as the Dallas stuff seems to be GPL, perhaps that applies here too...)
 *
 */
